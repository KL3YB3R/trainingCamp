<div id="users-container" style="display: none;">
    ...
    <form id="form_search_users" class="critetios-container">
        ...
        <button id="search_users" type="submit" class="p-3 button button-primary mt-10 mb-2" style="
        color: white; border: none; cursor: pointer;" data-action="search">
    ...
    <button data-modal-id="newUser" type="button" class="btnModal p-3 button button-primary mt-10 mb-2" style="color: white; border: none; cursor: pointer;">
